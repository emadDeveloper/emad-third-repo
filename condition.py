...
e2 = int(input("Emter your number for english2: "))
gm = int(input("Enter your number for gm: "))
religion = int(input("Enter your number for religion: "))
...
if((b<in1 or b>in2) or (e<in1 or e>in2) or (gm<in1 or gm>in2) or (religion<in1 or religion>in2) or (ss<in1 or ss>in2)
or (ict<in1 or ict>in2) or (phy<in1 or phy>in2) or (chem<in1 or chem>in2) or (hm<in1 or hm>in2)  
or(bio<in1 or bio>in2) or (phy_s<in1 or phy_s>in3) or (phy_p<in1 or phy_p>in4) or (chem_p<in1 or chem_p>in4)
or (chem_s<in1 or chem_s>in3) or (bio_s<in1 or bio_s>in3) or (bio_p<in1 or bio_p>in4) 
or (hm_s<in1 or hm_s>in3) or (hm_p<in1 or hm_p>in4)):
    print("The number is a invalid number")

elif(b1<f1 or b2<f1 or e1<f1 or e2<f1 or gm<f1 or religion<f1 or ss<f1 
or ict<f1 or hm_s<f2_s or hm_p<f2_p or phy_s<f2_s or phy_p<f2_p or chem_s<f2_s
or chem_p<f2_p or bio_s<f2_s or bio_p<f2_p):
    print("F")
    ...
    if(religion>0 and religion< 33 ):
        print("F")
        religion_g = 0.0
    elif(religion>32 and religion< 40 ):
        print("D")
        religion_g = 1.0 
    elif(religion>39 and religion< 50 ):
        print("C")
        religion_g = 2.0
    elif(religion>49 and religion< 60 ):
        print("B")
        religion_g = 3.0
    elif(religion>59 and religion< 70 ):
        print("A-")
        religion_g = 3.5
    elif(religion>69 and religion<80 ):
        print("A")
        religion_g = 4.0
    else:
        print("A+")
...
total_marks = b1 + b2 +e1 + e2 + gm + religion + ss + ict + phy_s + phy_p +chem_s + chem_p + hm_s + hm_p + bio_s + bio_p
